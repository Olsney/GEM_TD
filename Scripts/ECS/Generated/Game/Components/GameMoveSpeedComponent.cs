...
public partial class GameEntity {
    ...
    public Game.Battle.MoveSpeedComponent moveSpeed { get { return (Game.Battle.MoveSpeedComponent)GetComponent(GameComponentsLookup.MoveSpeed); } }
    ...
    public GameEntity AddMoveSpeed(float newValue) {
        ...
        var component = (Game.Battle.MoveSpeedComponent)CreateComponent(index, typeof(Game.Battle.MoveSpeedComponent));
