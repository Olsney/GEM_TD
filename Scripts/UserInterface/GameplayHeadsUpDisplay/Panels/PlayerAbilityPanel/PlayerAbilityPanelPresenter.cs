...
namespace UserInterface.GameplayHeadsUpDisplay.PlayerAbilityPanel
{
        ...
        IGoldListener
    {
        ...
        public void Enable()
        {
            ...
            {
                RegistrarAbilityView(_playerAbilities);
        ...
        private void RegistrarAbilityView(List<AbilitySetup> towerAbilities)
        {
            for (int i = 0; i < View.ButtonsView.Length; i++)
            {
                var button = View.ButtonsView[i];

                if (i > towerAbilities.Count - 1)
                {
                ...
                else
                {
                    ...
                    AbilitySetup ability = towerAbilities[i];
        ...
        private void UseAbility(AbilityEnum playerAbilityAbility)
        {
        ...
        public void Tick()
        {
            foreach (GameEntity portrait in _portraits)
            {
                if (portrait.hasTowerEnum)
                {
                    ...
                    RegistrarAbilityView(abilities);
                }
